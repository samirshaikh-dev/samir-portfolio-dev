      ...
      <div className="flex-1 p-6 md:p-10 max-w-3xl">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-text-muted mt-0.5">Fill in the details and publish when ready.</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-[11px] text-text-muted">Optional — leave blank to show initials avatar.</p>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            />
            <p className="text-[11px] text-text-muted">Shows a &quot;Verified ↗&quot; link on the card for extra trust.</p>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              placeholder="e.g. Samir delivered exactly what we needed, on time and with clear communication throughout the project..."
              required
            />
            <p className="text-[11px] text-text-muted">Aim for 40–80 words. Focus on reliability, results, and communication.</p>
          </div>

          {/* Rating + Display Order */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-1.5">
              <label className="block text-xs font-medium text-text-secondary">Star Rating (1–5)</label>
              <div className="flex items-center gap-2">
                {[1, 2, 3, 4, 5].map((star) => (
                  ...
                  >
                    <svg
                      className={`w-6 h-6 transition-colors ${star <= form.rating ? "text-amber-400" : "text-border-primary"}`}
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-3 py-2 text-sm border border-border-primary rounded-lg focus:ring-2 focus:ring-border-primary outline-none bg-background"
              />
              <p className="text-[11px] text-text-muted">Lower number = shown first.</p>
            </div>
          </div>
