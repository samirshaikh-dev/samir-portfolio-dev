...
export const metadata: Metadata = {
  title: "Engineering Services | Samir Shaikh — Backend & AI Engineering",
  description:
    "Reliable AI systems, knowledge retrieval pipelines, autonomous tool workflows, and scalable Node.js/NestJS backends built for startups and product teams.",
  keywords: [
...
const ENGAGEMENT_MODELS = [
  {
    ...
    badge: "High Velocity",
    subtitle: "For early-stage startups and founders looking to build or integrate an AI feature quickly.",
    highlights: [
      "Fixed-scope sprints (1 to 4 weeks)",
      "Targeted RAG, AI workflow, or API integration",
  ...
  },
  {
    ...
    subtitle: "For growing teams needing dedicated backend and AI engineering support.",
    highlights: [
  ...
  },
  {
    ...
    highlights: [
      "AI Backend Engineer / AI SDE / Full Stack roles",
      "Fluent in async communication across global timezones",
      "Strong foundation in Node.js, TypeScript, PostgreSQL, & AI SDKs",
...
const SERVICES_FAQS = [
  ...
  },
  {
    ...
    answer:
      "For targeted prototypes or specific feature integrations, initial working versions are typically delivered in 1 to 2 weeks. Full-scale backend architectures and production integrations typically range from 3 to 6 weeks depending on project complexity.",
  },
  {
    question: "Can you work with our existing tech stack?",
    answer:
      "Yes. Whether you are using Node.js, Express, NestJS, Next.js, or PostgreSQL, we integrate cleanly into your existing codebase, repository, and database without requiring disruptive rewrites.",
  },
  {
    ...
    <main className="flex flex-col flex-1 px-6 pb-24 md:px-10">
      ...
      <div className="max-w-6xl mx-auto w-full">
        <PageHeader
          ...
          subtitle="Reliable AI integrations, grounded knowledge retrieval, and scalable backend systems tailored for startups, founders, and product teams."
        />
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="max-w-2xl">
              <span className="font-mono text-xs uppercase tracking-wider text-green-600 dark:text-green-400 font-semibold bg-green-500/10 border border-green-500/30 px-2.5 py-1 rounded-full inline-block mb-3">
                ● Available for New Engagements & Remote Roles
              </span>
              <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground mb-3">
                Ship reliable AI and backend features into production.
              </h2>
              <p className="service-desc text-text-muted text-base leading-relaxed">
                I help startups and engineering teams design, build, and deploy reliable AI features, knowledge retrieval pipelines, and backend architectures built for real-world production.
              </p>
            </div>
        ...
        <div className="rounded-2xl border border-border-primary bg-card-bg p-8 md:p-12 text-center">
          ...
          <p className="text-text-muted text-sm max-w-xl mx-auto mb-8 leading-relaxed">
            Whether you need a grounded RAG knowledge pipeline, an automated AI workflow, or scalable backend APIs, let&apos;s talk through your goals.
          </p>
